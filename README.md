...
Milestone 4 TraceFinder: Model Deployment and Application Objective
...
System Architecture User Interface ↓ FastAPI Backend ↓ Trained CNN Model

Project Structure milestone4/ ├── backend/ │ ├── app.py │ ├── best_forensic_cnn.pth │ └── requirements.txt ├── frontend/ │ └── index.html
...
cd milestone4/backend python app.py
